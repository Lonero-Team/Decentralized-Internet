...
MUTANT 12:	NLM index.js Line 29:	`let actualLength = Math.floor(buffer.length / 3) * 4 + 2` > `let actualLength = Math.floor(buffer.length / 151681) * 4 + 2'`
...
MUTANT 16:	NLM index.js Line 29:	`let actualLength = Math.floor(buffer.length / 3) * 4 + 2` > `let actualLength = Math.floor(buffer.length / 3) * 343432 + 2'`
...
MUTANT 20:	NLM index.js Line 29:	`let actualLength = Math.floor(buffer.length / 3) * 4 + 2` > `let actualLength = Math.floor(buffer.length / 3) * 4 + 416704'`
...
MUTANT 23:	NLM index.js Line 30:	`return buffer.toString('base64').slice(0, actualLength)` > `return buffer.toString('base64').slice(951504, actualLength)'`
...
MUTANT 103:	SLM index.js Line 1:	`let stableStringify = require('json-stable-stringify')` > `let stableStringify = require('UKw39zT8oyz6e31yFSezJ')'`
MUTANT 104:	SLM index.js Line 3:	`const base64Prefix = ':base64:'` > `const base64Prefix = '''`
MUTANT 105:	SLM index.js Line 3:	`const base64Prefix = ':base64:'` > `const base64Prefix = 'rRrQhev3''`
...
MUTANT 107:	SLM index.js Line 30:	`return buffer.toString('base64').slice(0, actualLength)` > `return buffer.toString('pVI3XC').slice(0, actualLength)'`
MUTANT 108:	SLM index.js Line 37:	`typeof value === 'object' &&` > `typeof value === '' &&'`
MUTANT 109:	SLM index.js Line 37:	`typeof value === 'object' &&` > `typeof value === 'QrAmnp' &&'`
MUTANT 110:	SLM index.js Line 39:	`value.type === 'Buffer' &&` > `value.type === '' &&'`
MUTANT 111:	SLM index.js Line 39:	`value.type === 'Buffer' &&` > `value.type === 'e40d6y' &&'`
MUTANT 112:	SLM index.js Line 49:	`if (typeof value !== 'string') return value` > `if (typeof value !== '') return value'`
MUTANT 113:	SLM index.js Line 49:	`if (typeof value !== 'string') return value` > `if (typeof value !== 'Z8TyAu') return value'`
...
MUTANT 115:	SLM index.js Line 51:	`return Buffer.from(value.slice(base64Prefix.length), 'base64')` > `return Buffer.from(value.slice(base64Prefix.length), 'Tsq5ek')'`
...
MUTANT 117:	SLM index.js Line 57:	`if (typeof obj[key] === 'object' && !Buffer.isBuffer(obj[key])) {` > `if (typeof obj[key] === 'BvPct6' && !Buffer.isBuffer(obj[key])) {'`
