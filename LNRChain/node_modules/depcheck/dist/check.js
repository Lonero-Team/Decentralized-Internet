...
function buildResult(result, deps, devDeps, peerDeps, optionalDeps, skipMissing) {
  ...
  var missingDepsLookup = skipMissing ? [] : (0, _lodash2.default)(missingDeps).map(function (missingDep) {
...
function check(_ref5) {
  ...
  return checkDirectory(rootDir, rootDir, ignoreDirs, allDeps, parsers, detectors).then(function (result) {
    return buildResult(result, deps, devDeps, peerDeps, optionalDeps, skipMissing);
  });
}
